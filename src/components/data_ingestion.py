...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        logging.info('Enterered into the dataingestion configuration initiation.')
        try: 
            df: pd.DataFrame = export_collection_as_dataframe(collection_name='waterfault',db_name='saikiranpatnana')
            ...
            logging.info(f'ingested data from mongodb to {self.data_ingestion_config.raw_data_path}')
            logging.info(f'exited from initiate_data_ingestion method of DataIngestionclass')
